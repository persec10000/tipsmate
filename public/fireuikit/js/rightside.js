(function ($) {
    $(document).ready(function () {
        ...
        function uploadImage() {
            ...
            var uploader = $('<input type="file" name="addimage" accept="image/*" />')
            var images = $('.images')
            ...
            uploader.on('change', function () {
                ...
                reader.onload = function(event) {
                    images.prepend('<div class="img" name="upload" style="background-image: url(\'' + event.target.result + '\');" rel="'+ event.target.result  +'"><span>remove</span></div>')
                }
