    ...
    <div class="col-md-8 login_body mt-lg-5">
        ...
        <div class="row login_box">
            ...
            <div class="col-xs-12 col-sm-6">
                <form name="frm" id="frm" method="post" action="{{ route('login') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-5">
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" style="float: right;    color: #008cba;text-decoration: none;">Forgot your password?</a>
                        @endif
                    </div>
            ...
            <div class="col-xs-12 col-sm-6 pl-lg social-login-desktop-body">
                <div class="text-center social-btn">
                    <form method="get" class="facebook_login_form" action="{{url('/auth/facebook')}}">
