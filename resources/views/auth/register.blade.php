        ...
        <div class="row login_box">
            ...
            <div class="col-xs-12 col-sm-6">
                @if ($message = Session::get('success'))
                    ...
                    <br>
                @endif
                <form name="frm" id="frm" method="post" action="{{ route('register') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="Your First Name" name="name" value="{{old('name')}}" id="ame"
