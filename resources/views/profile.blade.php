...
<head>
    ...
    <link rel="stylesheet" href="{{asset('fireuikit/css/assets/profile.css')}}">
    <style>
        ...
        <div class="col-lg-9 col-md-9">
            ...
            <div class=" align-items-center" style="width: 100%; height: 30%">
                ...
                <ul class="nav" style="width: 100%" >
                    <li class="nav-item" >
                        <a class="hvr-rectangle-out" @if (Request::path()=='askme') style="background: #272727" @endif href="{{ route('ask_me') }}" id="askme">ASK ME</a>
                    </li>
                    <li class="nav-item">
                        <a class="hvr-rectangle-out" href="{{ url('howto') }}" id="howto" @if (Request::path()=='howto') style="background: #000000" @endif>HOW TO</a>
                    </li>
                    @if(!Auth::user())
                        <li class="nav-item">
                            <a class="hvr-rectangle-out" href="{{ route('register') }}" id="register" @if (Request::path()=='register') style="background: #000000" @endif>Register</a>
                        </li>
                        <li class="nav-item">
                            <a class="hvr-rectangle-out" href="{{ url('login') }}" id="login" @if (Request::path()=='login') style="background: #000000" @endif>Login</a>
                        </li>
                    @else

                        <li class="nav-item">
                            <a class="hvr-rectangle-out" href="{{ url('/profile') }}" id="register" @if (Request::path()=='register') style="background: #000000" @endif>Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="hvr-rectangle-out" href="{{ url('logout') }}" id="login" @if (Request::path()=='login') style="background: #000000" @endif>Logout</a>
                        </li>
                ...
                <div class="form-group row">
                    <div class="col-3">
                        <form action="/editprofile" method="post" enctype="multipart/form-data">
                            ...
                            <div style="text-align: center">
                                <img id="preview" src="{{asset('fireuikit/images/users/'.$user->image)}}" class="rounded-circle mb-2" style="width: 169px;height: 169px"><br>
                    ...
                    <div class="col-9">
                            <div class="row justify-content-between profile_top_section p-3">
                                <h4 class="col-2 profile_name">{{$user->name}}</h4>
                                <button class="col-2 profile_edit" id="desc_edit">Edit Description</button>
                            </div>

                            <div class="profile_second_section">
                                <textarea name="description" id="profile_description" form="form_editDesc" readonly>{{$user->description}}</textarea>
                ...
                <div class="row  border-top mt-2 ">
                    ...
                    <div class="col-4 mt-4">
                        <ul style="padding-left: 0">
                            <li>Asked Questions({{count($questions)}})</li>
                            <li>Answered Question({{count($answers)}})</li>
                            <li>"How to" Articles & Video Posts({{$article_video}})</li>
...
<script>
    ...
    function removeImage() {
        $('#preview').attr('src', '{{url('fireuikit/images/editprofile.png')}}');
        $('#remove').val(1);
    }
</script>
</html>
