        ...
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container" style="border: 2px solid #123456;padding: 20px;">
                ...
                <div class="m-login__signin">
                    ...
                    <form class="m-login__form m-form" id="frm_forgot" action="{{route('admin-send-password')}}" method="post">
                        @csrf
                    ...
                    <div class="form-group mb-5 d-flex justify-content-around">
                         <a href="{{route('admin-reset')}}"  style="float: right;    color: #008cba;text-decoration: none;" methods="post">Reset Password</a>
                    </div>
