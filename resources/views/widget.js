Function && Function.prototype && Function.prototype.bind && (/MSIE ([6789]|10)/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function (t) {
    ...
    var r = n(4), i = n(8), o = n(38), s = n(79), a = n(5), u = n(33), c = !1, d = /https?:\/\/([^/]+).*/i;
    t.exports = {
        setOn: function () {
            c = !0
    ...
    var r = n(83), i = n(75), o = n(84), s = n(8), a = n(71), u = n(74), c = n(20), d = n(5), l = n(23), f = n(0);
    ...
    var r = n(4), i = n(31), o = n(20), s = n(0), a = n(44), u = n(9), c = n(3), d = n(32), l = a.version,
        f = u.get("clientEventEndpoint") || "https://syndication.twitter.com/i/jot", h = 1;
    ...
    function m(t, e, n) {
        return e = e || {}, s.aug({}, e, {_category_: t, triggered_on: e.triggered_on || +new Date, dnt: o.enabled(n)})
    }
    ...
    t.exports = {
        ...
        clickEventElement: function (t) {
            var e = d.closest("[data-expanded-url]", t), n = e && e.getAttribute("data-expanded-url");
        ...
        splitLogEntry: function (t) {
            ...
            }), [s.aug({}, t, {item_ids: n, item_details: r}), s.aug({}, t, {item_ids: i, item_details: o})]) : [t]
        },
    ...
    t.exports = function () {
        function t(t) {
            ...
            t = t || {}, this.params = Object.keys(this.paramConfigs).reduce(function (n, s) {
                var a = [], u = e.boundParams, c = e.paramConfigs[s], d = c.validate || i, l = c.transform || o;
    ...
    var r = n(20), i = n(55), o = n(11), s = n(34), a = n(0), u = n(9).get("scribeCallback"), c = 2083, d = [],
        l = o.url(s.CLIENT_EVENT_ENDPOINT, {dnt: 0, l: ""}), f = encodeURIComponent(l).length;
    ...
    var r, i = n(2), o = n(4), s = n(96), a = n(49), u = n(9), c = n(97), d = n(24), l = n(100), f = n(154), h = n(162),
        p = n(163), m = n(29), v = n(35);
    ...
    var r, i = n(1), o = n(99), s = n(36), a = n(32), u = n(21), c = n(3), d = n(23), l = n(0), f = "intent_",
        h = i.screen.width, p = i.screen.height;
    ...
    r = (new o).defaults({
        ...
        var n = e && "click" == e.type && a.closest("a", e.target), r = e && (e.altKey || e.metaKey || e.shiftKey),
            i = n && (u.ios() || u.android());
    ...
    var r = n(4), i = n(52), o = n(6), s = n(22), a = n(53), u = n(33), c = n(9), d = n(39), l = n(24), f = n(5),
        h = n(0), p = n(35), m = n(117), v = n(29);
    ...
    !function () {
        ...
        function o() {
            this.frames = [], this.lastId = 0, this.raf = i, this.batch = {hash: {}, read: [], write: [], mode: null}
        }
    ...
    var r, i, o, s = n(4), a = n(1), u = n(30), c = n(20), d = n(2), l = n(6), f = n(55), h = n(34), p = n(0),
        m = n(25), v = n(9).get("scribeCallback"), g = Math.floor(1e3 * Math.random()) + "_",
    ...
    var r = n(4), i = n(10), o = n(18), s = n(56), a = n(26), u = n(57), c = n(45), d = n(46), l = n(30), f = n(12),
        h = n(47), p = n(2), m = n(6), v = n(0), g = n(9), w = n(23), y = n(7), b = {allowfullscreen: "true"}, _ = {
            position: "absolute",
            visibility: "hidden",
            display: "block",
            width: "0px",
            ...
            padding: "0",
            border: "none"
        }, E = {position: "static", visibility: "visible"}, x = "SandboxRoot", T = ".SandboxRoot { display: none; }",
        A = 50;
    ...
    var r, i = n(72), o = n(30), s = n(2), a = n(4), u = n(19), c = n(21), d = n(31), l = n(8), f = n(12), h = n(114),
        p = n(59), m = n(9), v = n(11), g = n(115), w = n(3), y = n(0), b = n(1), _ = p(function () {
            return new s
        });
        ...
        return a(t, c).map(function (t) {
            return u(function (t) {
                var e = t.getAttribute("data-show-screen-name"), n = s(t), a = t.getAttribute("href"),
                    ...
                    d = t.getAttribute("data-size"), l = r.decodeURL(a), f = l.recipient_id,
                    h = t.getAttribute("data-text") || l.text,
                    p = t.getAttribute("data-welcome-message-id") || l.welcomeMessageId;
                return o.aug(n, {screenName: u, showScreenName: c, size: d, text: h, userId: f, welcomeMessageId: p})
            }(t), t.parentNode, t)
        })
    }
}, function (t, e, n) {
    ...
    var r = n(122), i = n(1), o = n(10), s = n(36), a = n(18), u = n(56), c = n(26), d = n(57), l = n(45), f = n(47),
        h = n(7), p = n(46), m = n(6), v = n(0), g = 50,
        w = {position: "absolute", visibility: "hidden", display: "block", transform: "rotate(0deg)"},
        y = {position: "static", visibility: "visible"}, b = "twitter-widget", _ = "open", E = "SandboxRoot",
    ...
    t.exports = c.couple(n(58), function (t) {
        t.defineStatic("isSupported", function () {
            ...
            var i = this.targetGlobal.document, o = this._shadowHost = i.createElement(b),
                u = this._shadowRoot = o.attachShadow({mode: _}), c = this._shadowRootBody = i.createElement("div");
    ...
    var r = n(3), i = n(0), o = n(13), s = n(14)(), a = n(63), u = n(5), c = "a.twitter-follow-button";
    t.exports = function (t) {
    ...
    var r = n(8), i = n(1), o = n(31), s = n(2), a = n(21), u = n(0), c = n(3), d = n(7), l = a.ie9();
    ...
    t.exports = function (t, e) {
        return a(t, c).map(function (t) {
            return u(function (t) {
                var e = s(t), n = t.getElementsByTagName("A"), a = n && n[n.length - 1], u = a && i.status(a.href),
                    c = t.getAttribute("data-conversation"),
                    l = "none" == c || "hidden" == c || r.present(t, "tw-hide-thread"),
                    f = t.getAttribute("data-cards"), h = "none" == f || "hidden" == f || r.present(t, "tw-hide-media"),
    ...
    var r = n(10), i = n(0), o = n(13), s = n(14)(), a = n(69), u = n(5),
        c = "a.twitter-share-button, a.twitter-mention-button, a.twitter-hashtag-button", d = "twitter-hashtag-button",
    ...
    var r = n(8), i = n(12), o = n(3), s = n(0), a = n(5), u = n(66), c = n(67), d = n(17)([], {}, c), l = n(6),
