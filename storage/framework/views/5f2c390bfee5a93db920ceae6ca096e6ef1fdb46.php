...
<header>
    <div class="row hd">
        ...
        <div class="col-md-4">
            ...
            <div class="main-menu">
                <ul class="nav top-menu" style="margin-top:26px">
                    <li class="nav-item">
                    ...
                    <?php if(!Auth::user()): ?>
                        ...
                        <?php if(Route::has('register')): ?>
                            <li class="nav-item">
                                <a class="inactive" href="<?php echo e(route('register')); ?>" id="register" style="padding-left: 70px">REGISTER</a>
                            </li>
                        <?php endif; ?>
                    <?php else: ?>
...
<?php /**PATH F:\laravel\tipsmate\tipsmate\resources\views/profile.blade.php ENDPATH**/ ?>