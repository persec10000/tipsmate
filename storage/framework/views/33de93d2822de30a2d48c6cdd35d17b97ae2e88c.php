...
<div class="">
    <?php if(Auth::user()): ?>
        <a href="/howto/article/create"><p class="btn btn-create ">Create</p></a>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
                ...
                <a href="/article/<?php echo e($row1->data_id); ?>">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p cl   ass="card-text"><?php echo $row1->name; ?></p>
                        </div>
                    </div>
                </a>
            </li>
...
<?php echo $__env->make('layouts.basic1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gordon2012/public_html/tipsmate/resources/views/article.blade.php ENDPATH**/ ?>