...
<?php $__env->startSection('create'); ?>
    <div class="">
        <?php if(Auth::user()): ?>
            <a href="/howto/video/create"><p class="btn btn-create ">Create</p></a>
        <?php endif; ?>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.basic1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gordon2012/public_html/tipsmate/resources/views/howto/video.blade.php ENDPATH**/ ?>