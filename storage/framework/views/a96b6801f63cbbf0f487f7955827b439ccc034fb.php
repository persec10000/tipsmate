            ...
            <div class="m-login__container" style="border: 2px solid #123456;padding: 20px;">
                ...
                <div class="m-login__signin">
                    ...
                    <div class="d-flex justify-content-center" style="width:100%; align-content: center">
                        <a href="<?php echo e(route('admin-forgot')); ?>" id="forgot_link" methods="post">forgot password?</a>
                    </div>
...
<?php /**PATH F:\laravel\tipsmate\tipsmate\resources\views/admin/login.blade.php ENDPATH**/ ?>