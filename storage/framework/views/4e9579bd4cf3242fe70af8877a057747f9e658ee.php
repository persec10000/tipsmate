        ...
        <div class="row login_box">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <form name="frm" id="frm" method="post" action="/register" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="Your Full Name" name="name" id="ame"
...
<?php echo $__env->make('layouts.basic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gordon2012/public_html/tipsmate/resources/views/Register.blade.php ENDPATH**/ ?>