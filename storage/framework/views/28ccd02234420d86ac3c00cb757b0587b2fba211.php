        ...
        <div class="col-md-8">
            ...
            <div class=" align-items-center" style="width: 100%; height: 30%">
                    ...
                    <ul class="nav" style="width: 100%" >
                        <li class="nav-item" >
                            <a class="hvr-rectangle-out" <?php if(Request::path()=='askme'): ?> style="background: #272727" <?php endif; ?> href="/askme" id="askme">ASK ME</a>
                        </li>
                        <li class="nav-item">
...
<section>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-md-3" style="display: flex">
...
<?php /**PATH F:\laravel\tipsmate\tipsmate\resources\views/layouts/layout.blade.php ENDPATH**/ ?>