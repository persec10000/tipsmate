    ...
    <div class="col-md-8 login_body mt-lg-5">
        ...
        <div class="row login_box">
            ...
            <div class="col-xs-12 col-sm-6 pl-lg social-login-desktop-body">
                <div class="text-center social-btn">
                    <form method="get" class="facebook_login_form" action="<?php echo e(url('/redirect')); ?>">
                        <?php echo csrf_field(); ?>
                        <span for="btn_cta" class="btn-icon">
                            <span class="left-panel"></span>
...
<?php echo $__env->make('layouts.basic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gordon2012/public_html/tipsmate/resources/views/login.blade.php ENDPATH**/ ?>