    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#example').DataTable(
                {
                    processing: true,
                    serverSide: true,
                    ajax: "<?php echo e(route('admin.googleAds.index')); ?>",
                    columns: [
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("<?php echo e(route('admin.googleAds.index')); ?>" +'/' + id +'/edit', function (data) {
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    data: $send_data,
                    url: "<?php echo e(route('admin.googleAds.store')); ?>",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "<?php echo e(route('admin.googleAds.store')); ?>"+'/'+product_id,
                    success: function (data) {
                        table.draw();
                    },
                    error: function (data) {
...
<?php echo $__env->make('admin.basic', ['activeMenu' => 'Google Ads'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel\tipsmate\tipsmate\resources\views/admin/googleAds.blade.php ENDPATH**/ ?>